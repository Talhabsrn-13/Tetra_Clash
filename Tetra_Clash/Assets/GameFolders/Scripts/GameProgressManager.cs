...
public class GameProgressManager : MonoBehaviour 
{
	...
	public void SaveGame()
	{
		...
		//	for (int rowID = 0; rowID < player.GameBoardGenerator.TotalRows; rowID++) {
		//		string row = "";
		//		for (int columnID = 0; columnID < player.GameBoardGenerator.TotalColumns; columnID++) {
		//			row += (player.GamePlay.blockGrid [index].blockID + ",");
		//			index++;
		//		}
		...
		//	#region placing blocks
		//	xDocProgress.Root.Element ("ShapeInfo").Value = player.BlockShapeSpawner.GetAllOnBoardShapeNames ();
		//	#endregion


		//	#region score
		//	xDocProgress.Root.Element("Score").Value = player.ScoreManager.GetScore().ToString();
		//	#endregion

		//	#region total rescue done
		//	xDocProgress.Root.Element("TotalRescueDone").Value = player.GamePlay.TotalRescueDone.ToString();
		//	#endregion

		//	#region total free rescue done
		//	xDocProgress.Root.Element("TotalFreeRescueDone").Value = player.GamePlay.TotalFreeRescueDone.ToString();
		//	#endregion
		...
		//		List<Block> bombBlocks = player.GamePlay.blockGrid.FindAll (o => o.isBomb);
		...
		//	if(GameController.gameMode == GameMode.TIMED || GameController.gameMode == GameMode.CHALLENGE)
		//	{
		//		xDocProgress.Root.Element("RemainingTime").Value = player.GamePlay.timeSlider.GetRemainingTime().ToString();
		//	}
		//	#endregion

		//	#region moves count
		//	xDocProgress.Root.Element("MovesCount").Value = player.GamePlay.MoveCount.ToString();
		//	#endregion
